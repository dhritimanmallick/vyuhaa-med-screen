...
import AnnotoriousModule from "@recogito/annotorious-openseadragon";
...
const Annotorious = AnnotoriousModule.Annotorious || AnnotoriousModule.default || AnnotoriousModule;
...
const DeepZoomViewer = ({ tileSources, zoomLevel, xCoord, yCoord, annotDetArr, imageSettings, setViewer2, Doctor, tileName, widthTile, heightTile, scaleSelected }) => {
  ...
  useEffect(() => {
    ...
    let image = { "Image": { "Format": "jpeg", "Overlap": 1, "Size": { "Height": heightTile, "Width": widthTile }, "TileSize": 512, "Url": `http://localhost:3000/tile/${Doctor}/${tileName}/`, "xmlns": "http://schemas.microsoft.com/deepzoom/2008" }, "crossOriginPolicy": 'Anonymous', "ajaxWithCredentials": false, "useCanvas": true }
    // let image = { "Image": { "Format": "jpeg", "Overlap": 1, "Size": { "Height": heightTile, "Width":  widthTile}, "TileSize": 512, "Url": `http://localhost:3000/api/open-slide/`, "xmlns": "http://schemas.microsoft.com/deepzoom/2008" }, "crossOriginPolicy": 'Anonymous', "ajaxWithCredentials": false, "useCanvas": true }
    // let image = { "Image": { "Format": "jpeg", "Overlap": 1, "Size": { "Height": 61440, "Width":60928  }, "TileSize": 512, "Url": `http://localhost:3000/tile/${Doctor}/${tileName}/`, "xmlns": "http://schemas.microsoft.com/deepzoom/2008" }, "crossOriginPolicy": 'Anonymous', "ajaxWithCredentials": false, "useCanvas": true }
    // let image = { "Image": { "Format": "jpeg", "Overlap": 1 , "Size": { "Height": 79360, "Width":75264  }, "TileSize": 512, "Url": `http://localhost:3000/tile/${Doctor}/${tileName}/`, "xmlns": "http://schemas.microsoft.com/deepzoom/2008" }, "crossOriginPolicy": 'Anonymous', "ajaxWithCredentials": false, "useCanvas": true }
    ...
    anno.on('deleteAnnotation', async (annotation) => {
      ...
      await onFetchData('http://localhost:3000/deleteAnnotation', 'POST', { id: annotation.id })
    });

    anno.on("createAnnotation", async function (annotation) {


      await onFetchData('http://localhost:3000/getAnnotation', 'POST', annotation)
  ...
  const getSavedAnnotation = async () => {
    let savedData = await onFetchData('http://localhost:3000/getSavedAnnotation', 'GET',)
    return savedData;
  };
